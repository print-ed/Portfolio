...
export const projectsData = [
  {
    ...
    name: 'JS Game',
    category: 'finished',
    description: 'A simple text-based game made with vanilla javascript'
  },
  {
    id: '2',
    image: gagawin,
    name: 'GaGawin',
    category: 'ongoing',
    description: 'A kanban board app made with React'
  },
  {
    id: '3',
    image: ragsac,
    ...
    category: 'ongoing',
    description: 'A small business booking app'
  },
  {
    id: '4',
    image: projectic,
    ...
    category: 'finished',
    description: 'Project manager app made with MERN Stack'
  },
];
